          ...
          >
            ...
            <div className="space-y-5 text-muted-foreground leading-relaxed text-base">
              ...
              <p>
                ...
                Today, I work with restaurants, food brands, and lifestyle
                companies to craft images that not only showcase products but
                tell compelling stories.
              </p>
              <p>
                Every shoot blends creativity with technical precision -- 
                capturing the perfect mood, texture, and emotion. I believe great
                photography is about connection between the product and its
                audience.
              </p>
            </div>

            {/* Stats */}
            <div className="flex gap-10 mt-10 pt-10 border-t border-border/50">
